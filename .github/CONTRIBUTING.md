...
Here we have a set of instructions and guidelines to reduce misunderstandings and make the process of contributing to Spruce as smooth as possible.
...
As a user of Spruce, you're the perfect candidate to help us improve our documentation!
...
The [`question`](https://github.com/developer-nation/Spruce/labels/question)
and
[`rfc`](https://github.com/developer-nation/Spruce/labels/rfc)
...
- [`bug` issues](https://github.com/developer-nation/Spruce/labels/bug)
  are known bugs we'd like to fix;
- [`enhancement` issues](https://github.com/developer-nation/Spruce/labels/enhancement)
  are features we're open to include.

The
[`help wanted`](https://github.com/developer-nation/Spruce/labels/help%20wanted)
and
[`good first issue`](https://github.com/developer-nation/Spruce/labels/good%20first%20issue)
...
- Ensure your code is clean and reasonably bug-free;
